...
export default function Footer() {
  return (
    <div className = {styles.footerContainer}>
      ...
      <p>The information provided on this website, including financial charts and other data, is for informational purposes only and should not be construed as financial advice or a recommendation to buy or sell any securities. The content is based on data from sources believed to be reliable, but no representation or warranty, expressed or implied, is made as to its accuracy, completeness, or correctness.
